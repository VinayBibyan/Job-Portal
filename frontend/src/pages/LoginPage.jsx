...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const res = await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/auth/login`, formData);
  ...
  return (
    <div className="flex justify-center items-center h-screen bg-[#8ecae6]">
      <div className="bg-white p-8 rounded-lg shadow-lg w-96 text-[#023047]">
        <h2 className="text-3xl font-bold text-center mb-6 text-[#219ebc]">Login</h2>
